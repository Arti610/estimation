...
const PrintEstimation = () => {
  ...
  const EstimationData = useSelector(
    (state) => state.Estimation.updateEstimationData
  );
                ...
                <div className="print-content">
                          ...
                          <div>
                            <div style={{ marginBlock: "10px" }}>
                              <tr>
                                ...
                                <td>
                                  <b>&nbsp;:&nbsp;</b>
                                  {EstimationData &&
                                  EstimationData.estimation_header &&
                                  EstimationData.estimation_header
                                    .estimation_date
                                    ? EstimationData.estimation_header
                                        .estimation_date
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                {EstimationData &&
                                EstimationData.estimation_header &&
                                EstimationData.estimation_header.inquiry_no
                                  .customer.name
                                  ? EstimationData.estimation_header.inquiry_no
                                      .customer.name
                                  : null}
                  ...
                  <table className="quotation-detail-table">
                    ...
                    <tbody className="q-service-body">
                      {EstimationData &&
                        EstimationData.estimation_details?.map(
                          (item, index) => (
                            <tr>
                              <td style={{ paddingLeft: "8px" }}>
                                {item.inquirydetail.boq_number
                                  ? item.inquirydetail.boq_number
                                  : null}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                                {item.inquirydetail.unit
                                  ? item.inquirydetail.unit
                                  : null}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                                {item.inquirydetail.quantity
                                  ? item.inquirydetail.quantity
                                  : 0}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                                {item.inquirydetail.rate
                                  ? item.inquirydetail.rate
                                  : 0}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                                {item.inquirydetail.total_price
                                  ? item.inquirydetail.total_price
                                  : 0}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                              ...
                              <td style={{ paddingLeft: "8px" }}>
                                {item.taxable ? item.taxable : 0}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                                {item.vat_tax.name ? item.vat_tax.name : null}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                                {item.vat_tax.rate ? item.vat_tax.rate : 0}
                              </td>
                              <td style={{ paddingLeft: "8px" }}>
                  ...
                  <div className="amount-detail">
                    <tr>
                      ...
                      <td>
                        {EstimationData && EstimationData.NetTotal
                          ? EstimationData.NetTotal
                          : 0}
                      </td>
                    </tr>
                  </div>
